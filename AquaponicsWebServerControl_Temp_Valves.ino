...
void handleRoot() {
  String root = "<html>\
  <head>\
    <title>Aquaponics Admin Page</title>\
    <style>\
      body { background-color: #cccccc; font-family: Arial, Helvetica, Sans-Serif; Color: #000088; }\
    </style>\
  </head>\
  <h1>Set the Flood and Drain timers below</h1>\
    <form action='http://stwait.dyndns.org/BGBF' method='POST'>\
    Back_Grow_Bed_Fill_Time: <input type='text' name='BGBF'><br>\
    <input type='submit' value='Submit'>\  
    </form>\    
    <p></p>\
    <form action='http://stwait.dyndns.org/BGBD' method='POST'>\
    Back_Grow_Bed_Drain_Time: <input type='text' name='BGBD'><br>\
    <input type='submit' value='Submit'>\  
    </form>\    
    <p></p>\
    <form action='http://stwait.dyndns.org/LGBF' method='POST'>\
    Left_Grow_Bed_Fill_Time: <input type='text' name='LGBF'><br>\
    <input type='submit' value='Submit'>\
    </form>\      
    <p></p>\
    <form action='http://stwait.dyndns.org/LGBD' method='POST'>\
    Left_Grow_Bed_Drain_Time: <input type='text' name='LGBD'><br>\
    <input type='submit' value='Submit'>\ 
    </form>\     
    <p></p>\
    <form action='http://stwait.dyndns.org/RGBF' method='POST'>\
    Right_Grow_Bed_Fill_Time: <input type='text' name='RGBF'><br>\
    <input type='submit' value='Submit'>\  
    </form>\    
    <p></p>\
    <form action='http://stwait.dyndns.org/RGBD' method='POST'>\
    Right_Grow_Bed_Drain_Time: <input type='text' name='RGBD'><br>\
    <input type='submit' value='Submit'>\      
    </form>\
  </body>\
</html>";
    ...
    for ( uint8_t i = 0; i < server.args(); i++ ) {
      if (server.argName(i) == "BGBF") {
        ...
        // Serial.println(" Minutes");
         ...
         server.send(200, "text/plain", NewTime1);
      }
    }
  }
}
